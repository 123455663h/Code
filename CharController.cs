...
public class CharController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        rb.transform.position = transform.position + transform.forward * Time.deltaTime;    //角色移動
    }
    ...
    private void Update()
    {
        ...
        if (!Physics.Raycast(rayStart.position,-transform.up,out ray,Mathf.Infinity))    //Raycast(位置,方向往下,,距離) 判斷位置以下是否有碰撞體
        {
